    ...
    <div className="h-full md:h-screen flex px-10 py-[100px] md:px-10 md:py-[100px] lg:p-[100px] flex-col md:flex-row justify-center items-center font-poppinsRegular">
      <div className="h-full w-full flex flex-col justify-between md:w-1/2 md:pl-5 md:pr-10 lg:pr-[110px]" id="productList">
        ...
        >
          ...
          <div className="bg-primary-600 text-primary-200 h-8 w-8 rounded-full justify-center items-center flex mr-2">M</div>
          <span>Mava</span>
        </Link>
        ...
        <div className="mt-8 md:ml-11 flex flex-col w-full">
          <div id="avatar" className="flex">
            <div id="avatarModels" className="flex w-12 h-12">
              ...
              <img alt="avatarModel" className="w-6 h-12" src={require('../../assets/img/price2.png')} />
            </div>
            <div className="pl-3.5 flex flex-col flex-1">
              <span className="text-sm text-gray-900 font-poppinsMedium mb-0.5">Avatar Model</span>
              <span className="text-xs text-gray-600 font-poppinsMedium">Mava.fun - Create a one-of-a-kind AI art portrait of yourself or a loved one. Perfect for social media profile pictures, gifts, or just for fun. Purchase includes 50 Basic Pack images. Simply upload a portrait and let our AI algorithms do the rest.</span>
            </div>
        ...
        <div className="mb-20 md:ml-11 hidden md:flex font-poppinsMedium text-xs text-gray-500">
          <div className="flex items-center"> 
            ...
            <a href="#" className="mr-5">
              ...
              <path fillRule="evenodd" clipRule="evenodd" d="M16.0576 2.40183L18.4313 1.89716V0L16.0576 0.495319V2.40183Z"/>
              <path d="M18.4313 3.11182H16.0576V11.2892H18.4313V3.11182Z"/>
              <path fillRule="evenodd" clipRule="evenodd" d="M13.5138 3.80356L13.3625 3.11198H11.3198V11.2894H13.684V5.74745C14.242 5.02783 15.1877 5.15868 15.4809 5.26148V3.11198C15.1782 2.99984 14.0718 2.79423 13.5138 3.80356Z"/>
              <path fillRule="evenodd" clipRule="evenodd" d="M8.78548 1.08423L6.47796 1.5702L6.46851 9.05602C6.46851 10.4392 7.5182 11.4579 8.91787 11.4579C9.69328 11.4579 10.2607 11.3177 10.5728 11.1495V9.2523C10.2702 9.37382 8.77599 9.80369 8.77599 8.42056V5.10285H10.5728V3.11223H8.77599L8.78548 1.08423Z"/>
            ...
            <a href="#" className="mr-[18px]">Terms</a>
            <a href="#" className="mr-[18px]">Privacy</a>
          </div>
        </div>
      </div>
