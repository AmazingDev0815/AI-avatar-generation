export const LocalImg = {
  ...
  check01: require("../../assets/img/upload-check-01.png"),
  check02: require("../../assets/img/upload-check-02.png"),
  check03: require("../../assets/img/upload-check-03.png"),
  check04: require("../../assets/img/upload-check-04.png"),
  check05: require("../../assets/img/upload-check-05.png"),
  check06: require("../../assets/img/upload-check-06.png"),
  check07: require("../../assets/img/upload-check-07.png"),
  check08: require("../../assets/img/upload-check-08.png"),
